...
const Footer = () => {
  const policies = [
    { name: 'Política de Envío', href: '/politicas/envio' },
    { name: 'Política de Devoluciones', href: '/politicas/devoluciones' },
    { name: 'Contacto', href: '/politicas/contacto' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/manta-olfativa-para-perros" className="text-gray-300 hover:text-primary transition-colors duration-200">
